...
public class GameController : Controller
{
    private int MinValue
    {
        get
        {
            return HttpContext.Session.GetInt32("MinValue") ?? Int32.MinValue;
        }
        set
        {
            HttpContext.Session.SetInt32("MinValue", value);
        }
    }
    private int MaxValue
    {
        get
        {
            return HttpContext.Session.GetInt32("MaxValue") ?? -1;
        }
        set
        {
            HttpContext.Session.SetInt32("MaxValue", value);
        }
    }
    private int RandValue 
    {
        get
        {
            return HttpContext.Session.GetInt32("RandValue") ?? -1;
        }
        set
        {
    ...
    private int NumOfGuesses
    {
        get
        {
            return HttpContext.Session.GetInt32("NumOfGuesses") ?? 0;
        }
        set
        {
            HttpContext.Session.SetInt32("NumOfGuesses", value);
        }
    }
